...
public class Alert extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Alert\",\"fields\":[{\"name\":\"sensor_id\",\"type\":\"long\",\"doc\":\"The unique id that identifies the sensor\"},{\"name\":\"time\",\"type\":\"long\",\"doc\":\"Time alert generated as UTC milis from epoch\"},{\"name\":\"status\",\"type\":{\"type\":\"enum\",\"name\":\"AlertStatus\",\"symbols\":[\"Critical\",\"Major\",\"Minor\",\"Warning\"]},\"doc\":\"Allowed values sensors use for current status\"}]}");
  ...
  /** Time alert generated as UTC milis from epoch */
  private long time;
   ...
   * @param time Time alert generated as UTC milis from epoch
   ...
   * @return Time alert generated as UTC milis from epoch
   */
  public long getTime() {
    return time;
  }
